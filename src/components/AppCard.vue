    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div v-if="store.resultsMovies.length > 0">
                    ...
                    <div class="row row-cols-3">
                        <div v-for="item in store.resultsMovies" :key="item.id" class="card" style="max-width: 540px;">
                            <div class="row g-0">
                                <div class="col-md-4">
            ...
            <div v-if="store.resultsSeries.length > 0">
                ...
                <div class="row row-cols-3">
                    <div v-for="item in store.resultsSeries" :key="item.id" class="card" style="max-width: 540px;">
                        <div class="row g-0">
                            <div class="col-md-4">
